...
**GIT**: A system within GitHub which tracks code changes.

**GitHub**: GitHub is a platform that stores code in repositories. 

**Merge**: The process of integrating changes from one branch into another, typically the main branch.

**Merge Conflict**: When Git cannot automatically combine changes from different branches, requiring manual resolution by the developer.
